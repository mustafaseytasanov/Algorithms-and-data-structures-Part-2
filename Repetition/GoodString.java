...
хорошесть строки, которую можно собрать, используя дощечки из данного набора? Вы-то и поможете 
ему с ней справиться.
...
public class GoodString {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (long i = 0; i < n; i++) {
            ...
            k = Long.parseLong(string);
            array[(int) i] = k;
        }
        long output = 0;
        for (long i = 1; i < array.length; i++) {
            output += Math.min(array[(int) (i-1)], array[(int) i]);
        }
